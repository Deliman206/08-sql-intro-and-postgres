...
app.get('/articles', (request, response) => {
  // COMMENT: What number(s) of the full-stack-diagram.png image correspond to the following line of code? Which method of article.js is interacting with this particular piece of `server.js`? What part of CRUD is being enacted/managed by this particular piece of code?
  // This is Read from CRUD. This is #3 and #4 because this method is a get for query with a result from the database. The results are all of the articles. This method allows .fetchAll() to have something to grab from the database. The .fetchAll() pulls the "results" from the Database and passes them into a.loadAll() in order to display the articles on index.html.
...
app.put('/articles/:id', (request, response) => {
  // COMMENT: What number(s) of the full-stack-diagram.png image correspond to the following line of code? Which method of article.js is interacting with this particular piece of `server.js`? What part of CRUD is being enacted/managed by this particular piece of code?
  // This is an UPDATE from CRUD. This is #3 & #4 because this is response to a new article object being created by the submit event in new.html. It fires the updateRecord method which fires an AJAX request and then logs the data in the terminal. 
  client.query(
      `UPDATE articles
      SET
